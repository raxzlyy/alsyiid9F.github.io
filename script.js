...
function bindEvents() {
  ...
  openChatGPTButton.addEventListener("click", () => openExternalUrl("https://chat.openai.com"));
...
async function requestNotifications() {
  if (!("Notification" in window)) {
    notifyButton.textContent = "Gunakan Alert Biasa";
    return;
  }
...
function updateNotificationButton(permission) {
  ...
  if (currentPermission === "granted") {
    ...
    notifyButton.textContent = "Alert Saja";
  } else {
